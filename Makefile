...
LDFLAGS := -s -w \
	-X github.com/tamnd/clinicaltrials-cli/cli.Version=$(VERSION) \
	-X github.com/tamnd/clinicaltrials-cli/cli.Commit=$(COMMIT) \
	-X github.com/tamnd/clinicaltrials-cli/cli.Date=$(DATE)
