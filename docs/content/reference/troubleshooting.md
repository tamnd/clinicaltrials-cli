...
Most of these come down to network reality or how clinicaltrials serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

clinicaltrials rate-limits like any public site. ct already paces
...
Where a surface is gated, ct reads a cookie or token you supply
...
`ct`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ct actually did
