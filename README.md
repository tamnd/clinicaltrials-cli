...
`ct` is a single pure-Go binary. It speaks to clinicaltrials over plain
...
real commands in `cli/` on top of the `clinicaltrials` library package.

## Development

```
cmd/ct/   thin main, wires cli.Root into fang
cli/                 the cobra command tree
clinicaltrials/                the library: HTTP client and data models
